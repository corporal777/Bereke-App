package org.wilderkek.bereke.ui.my.inactive
...
class InActiveNotesFragment(
        ...
        viewModel.inActiveNotes.observe(viewLifecycleOwner) { list ->
            notesSection.apply {
                if (list.isNullOrEmpty()) {
                    ...
                    setHeader(TitleItemHome(getString(R.string.inactive_notes_title)))
    ...
    private fun showActionsDialog(noteId: String) {
        ActionsBottomSheetDialog(
            ...
            .setActionFirstCallback { viewModel.activateUserNote(noteId) }
